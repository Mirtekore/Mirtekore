...
Video presentation: https://youtu.be/gBIRtE1OJuc<br />
Technology used: Next.js, Tailwind, PostgreSQL
...
### Project Overview
One issue with farming machines are the specialized sensors used for detecting plant activities which have high costs. The e-nose is a low-cost chemical sensor built in-house by the University of Melbourne's Electrical Engineering and Agricultural schools with the aim of increasing the accessibility of Farmbot robots
...
Video presentation: https://youtu.be/gZxMMqkz224<br />
Technology used: Go, InfluxDB, Python


## 2. Sustainability pledge app

### Project Overview
This was our team's solution to bridge the gap between sustainability and technology. People can use the app to scan recyclable items and pledge to recycle them, thus reducing their carbon footprint. The goal of the app is to collectively fight back against high carbon emission activities (looking at you, XX's private jet flights). Investors who are environmentally conscious can also collab and set up sustainability events through our apps.

Demonstration link: https://wifi-wildflowers-hackathon.vercel.app/dashboard<br />
News article: https://eng.unimelb.edu.au/ingenium/student-life/bridging-innovation-and-sustainability-at-feits-hackathon-festival-2023<br />
Technology used: React, Google Firebase
...
Video presentation: https://youtu.be/gKgxQ2jPSjw<br />
...
Video presentation: https://youtu.be/FSuPuhsM_EA<br />
Technology used: Docker, Ansible, CouchDB, Nginx
...
In this project, we explore the question of “How do consumer buying habits and producer selling strategies influence the price of a product in a competitive market?”. We will use agent-based models (ABM) to allow each buyer and seller to act in a way that maximizes their own goals and analyze the collective impact of buyers and sellers towards each other and the market as a whole.
...
Demonstration link: https://spenk-diabetes.onrender.com<br />
Technology used: Handlebars, MongoDB
...
Video link: https://spenk-diabetes.onrender.com<br />
